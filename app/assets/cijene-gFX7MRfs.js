import{s as n}from"./index-CIS6RyBR.js";const l="ks.NabavnaCijenaBezPDV*(1-COALESCE(ks.RabatProcenat,0)/100)";function S(t,D=5){const i=n(`SELECT ks.StavkaID, ks.ArtikalID, COALESCE(a.Naziv,'(bez naziva)') AS Naziv, ks.Kolicina,
